...
<details>
  <summary>Bir Vaka Süreci Örneği</summary>
...
- Makine Öğrenimi ve Yapay Zeka: Belirsizlik altında çok sayıda kararı otomatikleştirmek içindir. Performans odaklıdır.
...
**Veri Analistinin Rolü:** İş sorunlarını veya ihtiyaçlarını belirleyip, verileri analiz ederek kalıpları ve eğilimleri ortaya çıkarır.
...
![VeriAnalisti](images/Veri_Analisti.png)
...
<details>
  <summary>Bir Vaka Örneği</summary>

  <h4>Senaryo: Daha iyi filmler oluşturmak için verileri kullanın</h4>
  <p>Mega-Pik'in son zamanlarda çıkardığı filmler eskisi kadar etkili olamıyor. Son altı filmlerinden beşi gişede zar zor zarar etti ve altıncı film de çok para kaybetti. Mega-Pik'in başındaki yöneticiler rakiplerinin de benzer bir çöküş yaşadığını, ancak geçmiş başarılarının yeniden yapımlarını üretmeye ve bunları yeni bir izleyici kitlesine pazarlamaya başladıklarında toparlandıklarını fark ettiler. 

Mega-Pik bu trendi takip etmekle ilgileniyor. Bunu veriye dayalı stratejiler temelinde yapmak istiyorlar, bu nedenle yeniden popüler filmler yapmalarına yardımcı olması için analiz şirketinizi işe alıyorlar. Özellikle, izleyicilerin geçmişte neleri sevdiğini anlamalarına ve bu filmlerin başarılarının tekrarlanıp tekrarlanamayacağını belirlemelerine yardımcı olması için keşifsel veri analizi (EDA) istiyorlar.   

Siz ve ekibiniz Mega-Pik'in EDA'sı için aşağıdaki hedefleri geliştirin:
<ul>
    <li>Bir filmin açılış hafta sonu başarısına katkıda bulunan temel faktörleri belirleyin.</li>
    <li>Bir filmin bütçesi ile hasılatı arasındaki ilişkiyi anlamak.</li>
    <li>Hangi türlerin en başarılı olduğunu belirleyin.</li>
</ul>
</p>

<h5>Doğru veri seti</h5>
<p>
    Şirketiniz aşağıdaki ilgili bilgileri toplar, temizler ve bir veri kümesi halinde düzenler:
    <ul>
        <li>Film adı</li>
        <li>Çıkış tarihi</li>
        <li>Açılış gecesi geliri</li>
        <li>Açılış hafta sonu geliri</li>
        <li>Bütçe (oluşturma maliyeti)</li>
        <li>Pazarlama maliyetleri</li>
        <li>Derecelendirmeler</li>
        <li>Tür</li>
    </ul>
</p>

<h5>Becerilerinizi kullanın</h5>
<p>Şimdi, doğuştan gelen veri analizi becerilerinin Mega-Pik'i hangi filmlerin üretileceği konusunda veri odaklı kararlar almaya yönlendirmenize nasıl yardımcı olabileceğini inceleyeceksiniz. </p>

<h6>Merak</h6>
<img src="https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/Mw8q10qaTROrrm-3p_rW3w_8c9bc71a286c49e2aaaa7cb528894bf1_D1G003.png?expiry=1734825600000&hmac=xMlmOSnrv7a50sY5JDNxpAM9if6zIeG0Fn12LMjzpIw" alt="Merak eden Veri Analisti" />
<p>Bu veri analizini gerçekleştiren şirket için çalışsaydınız, verilere ve bunların EDA'nın hedefleriyle ilişkisine dayanarak ne tür sorular sorardınız? Merak burada çok önemlidir, çünkü cevaplayabileceğiniz sorular bulmanıza yardımcı olacaktır

Örneğin, bir filmin bütçesi ile açılış gecesinde veya açılış hafta sonunda elde ettiği gelir arasında bir ilişki olup olmadığını merak edebilirsiniz. Ayrıca, hangi türlerin açılış hafta sonunda daha iyi performans gösterme eğiliminde olduğu gibi yeni ölçütler oluşturmak için sütunları birleştirmeyi de merak edebilirsiniz - hem genel olarak hem de filmlerin gösterime girdiği sezonlarda. Hatta izleyici demografisi gibi halihazırda sahip olmadığınız ek veri sütunları olup olmayacağını bile sorabilirsiniz.

Merak, analistleri verilerden beklenen veya beklenmeyen şekillerde ne kadar bilgi çıkarabileceklerini keşfetmeye iten bir beceridir. Analistleri verileri hakkında sondaj soruları sormaya iten tek becerinin merak olmadığını unutmayın. </p>

<h6>Bağlamı anlama</h6>
<img src="https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/LJUT_47wS_qiilJO4Ull2g_86d3972b5a804ebfaa73e3655e68eef1_D1G004.png?expiry=1734825600000&hmac=JS3oYo0B28whYHxLDx7-1fQKDWtkc3ydFph43Qxnypw" alt="Context Puzzle" />
<p>Bağlam, her türlü anlamlı veri analizi için çok önemlidir. Verileri bağlamsallaştırarak, verilerin neyi neden gösterdiğini anlamaya başlarsınız. Bir filmin gösterime girdiği yıl, tatiller ve rakip etkinlikler gibi faktörlerin tümü, Mega-Pik'in başarıyı belirlemek için kullandığı gösterge olan gelir üzerinde etkili olabilir. Yaş, cinsiyet, eğitim ve gelir düzeyi gibi izleyici demografileri sinemaya kimlerin gittiğini anlamanıza yardımcı olabilir. Bu bağlam, hangi türlerin veya hikayelerin sinemaya gidenler için en ilginç olduğunu netleştirebilir.   

Analistler, bir veri kümesindeki kalıpları veya anormallikleri arayarak bağlamı belirler. Bu aynı zamanda eğlence sektörünü anlamaya da yardımcı olur ve bu da başka bir dizi bağlamsal ipucu sağlar. Örneğin, aile filmleri genellikle çocuklar okul tatilindeyken daha fazla gelir elde eder. Bu, kısa bir zaman diliminde tür ve gelir arasındaki ilişki hakkında önemli bir bağlam sağlar. Aile filmleri ile hasılat arasındaki ilişkiyi anlamak için, okul takvimine dayalı yanlış sonuçlardan kaçınmak amacıyla bir yıldan daha uzun bir zaman dilimini araştırmanız gerekebilir. Ayrıca, çocukların okuldan tatile çıktıkları "mevsim" ülkeden ülkeye farklılık gösterir; bu da dikkate almanız gereken bir başka bağlamsal ipucudur. Bu verilerin doğru bir analizi, harici veriler veya tarihsel eğilimler de dahil olmak üzere çeşitli bağlamların tümünün çapraz referanslandırılmasıyla elde edilmelidir. 

Bağlamı anlamak, sonucu etkileme olasılığı en yüksek olan değişkenleri daraltarak sorunları çözmenize yardımcı olur ve bu da daha anlamlı içgörüler elde etmenizi sağlar.</p>

<h6>Teknik zihniyet</h6>
<img src="https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/Lb_9BUAgSieBwMTzGkZaCw_50f196769426442993158fe345a6c8f1_D1G005.png?expiry=1734825600000&hmac=SGSDT0UCosP_o-qsvUtBLuMgBh-INcnu4APqFJQEwbE" alt="Teknik Zihniyet" />
<p>Keşfettiğiniz gibi, teknik bir zihniyete sahip olmak, sorunlara (ve veri kümelerine) sistematik ve mantıklı bir şekilde yaklaşmak anlamına gelir. Bu, verilerinizi temizleme, düzenleme ve hazırlama şeklinizle başlar. Ayrıca, verileri parçalara ayırmak için kullandığınız araçlara veya yazılımlara rehberlik edebilir ve analizinizi çarpıtabilecek yanlış verileri belirlemenize ve düzeltmenize yardımcı olabilir. 

Unutmayın ki sorunlar her zaman teknik değildir, ancak teknik bir zihniyet, herhangi bir karmaşık sorunu yönetilebilir parçalara ayırmak için kullandığınız beceridir. Neye benzediğine bakmaksızın bir süreci uygulamaya odaklanmak, teknik zihniyetinizi kullanmak için harika bir ilk adımdır.</p>

<h6>Veri tasarımı</h6>
<img src="https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/CY2P2wDrR9GKSjvT6oDKkw_cccfe7faeded4545b0bcfb8d748722f1_D1G006.png?expiry=1734825600000&hmac=0yi07z7XazLkIjvDtQd3csWa8ih-g7RUhDOE4aALvOo" alt="Veri Tasarımı" />
<p>Veri tasarımı becerisi, teknik zihniyetinizin bir uzantısıdır. Bilginin nasıl organize edildiği ile ilgilenir. Buradaki veri kümesinin bir elektronik tabloda sunulduğunu varsayalım. Farklı modeller bulmak amacıyla verileri düzenlemek için hücreleri değiştirebilirsiniz. Örneğin, verileri gelire göre ve daha sonra türe göre düzenleyebilirsiniz, bu da komedilerin dramalardan daha karlı olduğunu ortaya çıkarabilir. Temel olarak, verilerinizi nasıl yapılandırmayı seçtiğiniz analizi daha kolay ve daha anlayışlı hale getirir.  </p>

<h6>Veri stratejisi</h6>
<img src="https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/t-eqPUbYRxKpMZ3y1l3F4w_9fe531e40edc4fdb8c6a84df8095faf1_D1G007.png?expiry=1734825600000&hmac=2j_-4SAL808CWRHdsM3Ka09lzZALb_jkWhqMkZJVvvE" alt="Veri Stratejisi" />
<p>Veri stratejisi, veri analizinde kullanılan kişilerin, süreçlerin ve araçların yönetimidir. Bu senaryoda, veri setinizi analiz etmek için kullandığınız yaklaşım olarak düşünün. Bir unsur, kullandığınız araçlar olabilir. Mega-Pik nispeten basit bir gösterge tablosu istiyorsa, yalnızca birkaç sütun veri olduğu için Google E-Tablolar veya Excel kullanabilirsiniz. Öte yandan, Mega-Pik her yeni veri geldiğinde bilgilerin güncellendiği bir gösterge tablosu istiyorsa, Tableau gibi sağlam bir araca ihtiyacınız olacaktır.

Seçeceğiniz veri stratejisi, veri kümesine ve çıktılara göre belirlenmelidir. Veri stratejisini bir tür kaynak tahsisi olarak düşünün; bir projeye harcadığınız araçlar, zaman ve çaba, neyi başarmanız gerektiğine bağlı olarak değişecektir. Bu vaka çalışması için kullanabileceğiniz bir strateji, bir sonraki çeyreğin gelirini doğrudan etkileyecek analizlere öncelik vermektir. Kaynakları tahsis etme şekliniz sizi daha hızlı, daha eyleme geçirilebilir içgörülere götürebilir.</p>

  <h5>Anahtar Çıkarımlar</h5>
  <p>Doğuştan gelen analitik becerileriniz veri analizi yapmak için gereklidir ve bunları bu programdaki araç ve tekniklerle birleştirdiğinizde daha da kritik hale gelecektir. Bu becerileri iş senaryolarında nasıl kullanacağınızı anlamak, onları daha da geliştirmek ve kariyerinizde etkili bir şekilde kullanmak için ilk adımdır. </p>
...
1. **Kök Neden Analizi (Beş Neden Tekniği):**
...
<details>
    <summary>"Beş neden" uygulama örneği</summary>
    <p>
        Bir online market, kötü teslimatlarla ilgili çok sayıda müşteri hizmetleri şikayeti alıyordu. Bu sorunu çözmek için şirketteki bir veri analisti ilk "neden?" sorusunu sordu

<b>Neden 1.</b> "Müşteriler market teslimatlarının kötü olmasından şikayetçi. Neden?"

Veri analisti işe müşteri geri bildirimlerini daha yakından inceleyerek başladı. Şikayetlerin büyük çoğunluğunun ürünlerin hasarlı gelmesiyle ilgili olduğunu fark ettiler. Bu yüzden tekrar "neden?" diye sordular.

<b>Neden 2.</b> "Ürünler hasarlı geliyor. Neden?"

Veri analisti bu soruyu yanıtlamak için müşteri geri bildirimlerini incelemeye devam etti. Birçok müşterinin ürünlerin düzgün paketlenmediğini söylediği ortaya çıktı.

<b>Neden 3.</b> "Ürünler düzgün paketlenmemiş. Neden?"

Üçüncü "neden" sorusunu sorduktan sonra veri analisti biraz daha dedektiflik çalışması yaptı. Sonunda şirketlerinin market paketleyicilerinin paketleme prosedürleri konusunda yeterince eğitimli olmadığını öğrendiler.

<b>Neden 4.</b> "Market paketleyicileri yeterince eğitimli değil. Neden?"

Bu "neden", veri analistinin tüm paketleyicilerin yaklaşık %35'inin şirkette yeni olduğunu ortaya çıkarmasını sağladı. Henüz gerekli tüm eğitimleri tamamlama şansları olmamıştı, ancak şimdiden müşteri siparişleri için market ürünlerini paketlemeleri isteniyordu.

<b>Neden 5.</b> "Paketleyiciler gerekli eğitimi tamamlamadı. Neden?"

Bu son "neden?" sorusu, veri analistinin insan kaynakları departmanının yeni işe alınan hiçbir paketleyiciye gerekli eğitimi vermediğini öğrenmesine yol açtı. Bunun nedeni İK'nın eğitim programını yeniden düzenleme aşamasında olmasıydı. Yeni işe alınanlara eski sistemi kullanarak eğitim vermek yerine, onlara tek sayfalık hızlı bir kılavuz sunmuşlardı ve bu da yetersizdi.

Yani bu örnekte, sorunun temel nedeni İK'nın eğitim programı güncellemelerini tamamlamamış olması ve yeni paketleyicileri eğitmek için daha az kapsamlı bir kılavuz kullanmasıydı. Neyse ki bu, bakkalın kontrol edebileceği bir sorundu. Ve veri analistinin çalışması sayesinde, İK departmanına eğitimi tamamlaması ve yeni işe alınan tüm market paketleyicilerini yeniden eğitmesi için daha fazla destek sağladılar!
    </p>
</details>

<details>
    <summary>"Beş neden" uygulama örneği 2</summary>
    <p>
        Bir sulama şirketi, su pompalarındaki arıza sayısında bir artış yaşıyordu. Şirketin veri ekibi durumu analiz etmek için beş nedeni kullandı:

<b>Neden 1.</b> "Su pompalarındaki kusurların sayısında bir artış oldu. Neden?"

Veri ekibi bu soruyu yanıtlamak için atölye mühendisleriyle bir toplantı düzenledi. Makine performansı ve üretim süreçleri hakkında bazı bilgiler istediler. Biraz araştırmadan sonra, pompaları üretmek için kullanılan makinelerin uygun şekilde kalibre edilmediği keşfedildi.

<b>Neden 2.</b> "Makineler uygun şekilde kalibre edilmemiş. Neden?"

Mühendislik ekibiyle daha fazla beyin fırtınası yapıldıktan sonra, makinelerin son bakım döngüsü sırasında yanlış kalibre edildiği belirlendi.

<b>Neden 3.</b> "Makineler bakım sırasında yanlış kalibre edildi. Neden?"

Ardından, veri ekibi makine kalibrasyonu ile ilgili prosedürleri araştırdı. Mevcut yöntemin makineler için uygun olmadığını tespit ettiler.

<b>Neden 4.</b> "Kalibrasyon yöntemi makineler için uygun değil. Neden?"

Bu "neden" onları şirketin yakın zamanda makinelerine yeni bir yazılım yüklediğini keşfetmeye yöneltti. Bu küçük bir yazılım güncellemesi olduğu için mühendisler bunun kalibrasyonu etkileyeceğini fark etmemişlerdi. Yükseltilen makineleri düzgün bir şekilde kalibre etmek için ihtiyaç duydukları bilgiye sahip değillerdi.

<b>Neden 5.</b> "Mühendisler, yükseltilen makineleri kalibre etmek için ihtiyaç duydukları bilgiye sahip değiller. Neden?"

Beşinci ve son "neden" daha da fazla kanıt ortaya çıkardı: Kurulum ekibi makine yazılımını yükseltmiş, ancak ilgili kalibrasyon prosedürlerini mühendislerle paylaşmamıştı.

Yani bu örnekte sorunun temel nedeni, mühendislerin yeni yazılım sistemini kullanarak makinelerin nasıl kalibre edileceğine dair önemli bilgilerden yoksun olmasıydı. Çözüm bulundu ve sulama şirketi bunu hemen uygulayabildi. Kısa süre içinde mühendisler gerekli kalibrasyon talimatlarına sahip oldular ve pompa arızaları ortadan kalktı!
    </p>
</details>
...
<details>
    <summary>Gerçek Dünya Örneği1: Google - Yönetici Değeri</summary>
    Google’ın İK ekibi, yöneticilerin değerli olup olmadığını analiz etmek istedi.

<b>Veri Analiz Süreci:</b>

Çalışan anketleri ve performans incelemeleri incelendi.
Veriler grafiklerle görselleştirildi ve çeyreklere bölündü.
Sonuç: En iyi yöneticilere sahip ekipler daha mutlu, üretken ve şirkette kalma olasılıkları daha yüksekti.

<b>Derinlemesine Araştırma:</b>
Çalışanlar favori yöneticilerini aday gösterebildi ve bu yöneticilerin güçlü yönlerini belirtti.
En iyi ve en kötü yöneticilerle görüşmeler yapıldı.
Sonuçta, başarılı yöneticilerin davranışları belirlendi ve tüm yöneticiler bu standartlara göre değerlendirilmeye başlandı.
Sonuç: Google’ın veri odaklı yaklaşımı, yöneticilerin şirket kültürüne olan etkisini anlamada ve bu kültürü güçlendirmede etkili oldu.
</details>

<details>
    <summary>Gerçek Dünya Örneği2: Kar Amacı Gütmeyen Sektör Örneği</summary>
    Amaç: Kar amacı gütmeyen kuruluşların etkisini artırmak için gazetecilerle nasıl işbirliği yapabileceklerini anlamak.
    
<b>Veri Analiz Süreci:</b>
Hikaye konuları, tıklamalar, web trafiği, yorumlar ve paylaşımlar gibi metrikler izlendi.
Gazetecilere işlerini daha etkili yapmaları için önerilerde bulunuldu.
Sonuç: Bu işbirliği, okuyucuların farkındalıklarını artırdı ve daha fazla katılım sağladı. Örneğin, çevreye duyarlı bir yazı, okuyucuları yeşil seçimler yapmaya, bağış yapmaya veya gönüllü olmaya teşvik etti.

    
</details>

<details>
    <summary>Terimler Sözlüğü</summary>
    <b>Analitik beceriler:</b> Sorunları çözmek için gerçekleri kullanmakla ilişkili nitelikler ve özellikler

<b>Analitik düşünme:</b> Bir problemi belirleme ve tanımlama, ardından organize, adım adım bir şekilde verileri kullanarak çözme süreci

<b>Bağlam:</b> Bir şeyin içinde bulunduğu veya gerçekleştiği durum

<b>Veri:</b> Gerçeklerin bir koleksiyonu

<b>Veri analizi:</b> Sonuç çıkarmak, tahminlerde bulunmak ve bilgiye dayalı karar alma sürecini yönlendirmek için verilerin toplanması, dönüştürülmesi ve düzenlenmesi

<b>Veri analisti:</b> Sonuç çıkarmak, tahminlerde bulunmak ve bilgiye dayalı karar alma süreçlerini yönlendirmek için veri toplayan, dönüştüren ve düzenleyen kişi

<b>Veri analitiği:</b> Veri bilimi

<b>Veri tasarımı:</b> Bilginin nasıl organize edildiği

<b>Veriye dayalı karar verme:</b> İş stratejisini yönlendirmek için gerçekleri kullanma

<b>Veri ekosistemi:</b> Veri üretmek, yönetmek, depolamak, düzenlemek, analiz etmek ve paylaşmak için birbiriyle etkileşim halinde olan çeşitli unsurlar

<b>Veri bilimi:</b> Bilinmeyeni modellemek ve anlamak için yeni yollar oluşturmak üzere ham verileri kullanan bir çalışma alanı

<b>Veri stratejisi:</b> Veri analizinde kullanılan kişilerin, süreçlerin ve araçların yönetimi

<b>Veri görselleştirme:</b> Verilerin grafiksel gösterimi

<b>Veri kümesi:</b> Tek bir birim olarak manipüle veya analiz edilebilen bir veri koleksiyonu

<b>Boşluk analizi:</b> Gelecekte iyileştirme fırsatlarının belirlenmesi amacıyla bir sürecin mevcut durumunun incelenmesi ve değerlendirilmesine yönelik bir yöntem

<b>Kök neden:</b> Bir sorunun ortaya çıkmasının nedeni

<b>Teknik zihniyet:</b> İşleri daha küçük adımlara veya parçalara ayırma ve bunlarla düzenli ve mantıklı bir şekilde çalışma becerisi
</details>
...
<details>
    <summary>Veri döngüsünde farklı kurumların benzer yaklaşımları</summary>
    <p>
        ABD Balık ve Yaban Hayatı Servisi
ABD Balık ve Yaban Hayatı Servisi aşağıdaki veri yaşam döngüsünü kullanır:
...
ABD Balık ve Yaban Hayatı Veri Yönetimi Yaşım Döngüsü sayfasına
 bakın.

ABD Jeolojik Araştırması (USGS)
USGS aşağıdaki veri yaşam döngüsünü kullanır:
...
Yaşamlarının her aşamasında çeşitli çapraz veya kapsayıcı faaliyetler de gerçekleştirilir:

Tanımlayın (meta veriler ve belgeler)
...
Daha fazla bilgi için 
USGS Veri Yaşama Döngüsü
 sayfasına bakın.

Finansal kurumlar
Finansal kurumlar, Stratejik Finans dergisindeki bir makale olan The Data Life Cycle'da açıkl 
andığı gibi veri yaşam döng
 üsüne biraz farklı bir yaklaşım benimseyebilir:
...
Harvard İşletme Okulu (HBS)
Harvard Üniversitesi araştırması tarafından bildirilen son bir veri yaşam döngüsü sekiz aşamadan oluşur:
...
Daha fazla bilgi için Veri Yaşama 
Döngüsündeki 8 Adım bölümüne bakın
. 
    </p>
</details>
...
**Veritabanı:** Bir bilgisayar sisteminde depolanan veri koleksiyonu

**Formül:** Bir elektronik tablodaki verileri kullanarak bir hesaplama yapmak için kullanılan talimatlar kümesi

**İşlev:** Bir elektronik tablodaki verileri kullanarak belirli bir işlemi veya görevi otomatik olarak gerçekleştiren önceden ayarlanmış bir komut

**Sorgu:** Bir veritabanından veri veya bilgi talebi

**Sorgu dili:** Bir veritabanı ile iletişim kurmak için kullanılan bir bilgisayar programlama dili

**Paydaşlar:** Bir projeye zaman ve kaynak yatırımı yapan ve projenin sonucuyla ilgilenen kişiler

**Yapılandırılmış Sorgu Dili:** Bir veritabanı ile iletişim kurmak için kullanılan bir bilgisayar programlama dili

**Elektronik tablo:** Dijital bir çalışma sayfası
...
Gözlem(Observation): Gözlem, veri tablosunun bir satırında bulunan bir şeyin tüm niteliklerini içerir.
Örneğin:
<table>
    <tr>
        <th>First Name</th>
...
- Bu tablodaki satır başlarındaki "Fiyat" ve "Değerler" hücreleri tablo için öznitelik sayılmaz. Gözlem olarak değerlendirilir.
...
<details>
    <summary>SQL'i bir veri analisti olarak kullanmak</summary>
    Küçük bir işletmede veri analisti olduğunuzu ve yöneticinizin sizden bazı çalışan verilerini istediğini düşünün. Veritabanından ihtiyacınız olanı almak için SQL ile bir sorgu yazmaya karar veriyorsunuz.

Tüm sütunları çekmek istiyorsunuz: empID, firstName, lastName, jobCode ve salary . Veritabanının o kadar büyük olmadığını bildiğiniz için, SELECT cümlesine her bir sütun adını girmek yerine SELECT * kullanırsınız. Bu, FROM cümlesindeki Employee tablosundan tüm sütunları seçecektir.
...
Şimdi, Employee tablosundan istediğiniz veriler hakkında daha spesifik olabilirsiniz. 'SFI' iş kodunda çalışan çalışanlarla ilgili tüm verileri istiyorsanız, verileri bu ek gereksinime göre filtrelemek için bir WHERE cümlesi kullanabilirsiniz.

Burada şunları kullanırsınız:
...
'SFI' iş kodu için geniş bir maaş aralığı fark ettiğinizi varsayalım. Yöneticiniz için daha düşük maaşlı tüm departmanlardaki tüm çalışanları işaretlemek isteyebilirsiniz. Stajyerler de tabloya dahil edildiğinden ve maaşları 30.000 $'dan az olduğundan, sonuçlarınızın yalnızca 30.000 $ veya daha az maaş alan tam zamanlı çalışanları verdiğinden emin olmak istersiniz. Başka bir deyişle, 'INT' iş koduna sahip olan ve 30.000 $'dan az kazanan stajyerleri hariç tutmak istiyorsunuz. AND cümlesi her iki koşulu da test etmenizi sağlar.

Aşağıdakine benzer bir SQL sorgusu oluşturursunuz, burada <> "eşit değil" anlamına gelir:
...
SQL kullanarak bu tür verilere hızlı bir şekilde erişerek, yöneticinize işletme genelinde çalışan maaşlarının adil olup olmadığı da dahil olmak üzere çalışan verileri hakkında tonlarca farklı içgörü sağlayabilirsiniz. Neyse ki, sorgu yalnızca iki çalışanın daha maaş ayarlamasına ihtiyaç duyabileceğini gösteriyor ve sonuçları yöneticinizle paylaşıyorsunuz.

Verileri çekmek, analiz etmek ve bir çözüm uygulamak nihayetinde çalışan memnuniyetini ve bağlılığını artırmaya yardımcı olabilir. Bu da SQL'i oldukça güçlü bir araç haline getiriyor.
</details>
...
<details>
    <summary>Veri Görselleştirme Adımları</summary>
    Bir veri analistinin paydaşlarla paylaşmak için bir veri görselleştirme oluşturması gerekebileceği gerçek hayattaki bir durum örneğini inceleyelim. Bir giyim distribütörü için veri analisti olduğunuzu düşünün. Şirket, küçük giyim mağazalarının envanterlerini yönetmelerine yardımcı oluyor ve satışlar artıyor. Bir gün, şirketinizin web sitesinde büyük bir güncelleme yapmaya hazır olduğunu öğrenirsiniz. Web sitesi güncellemesine ilişkin kararlara rehberlik etmek için, mevcut web sitesinden ve satış kayıtlarından gelen verileri analiz etmeniz istenir. İzleyebileceğiniz adımları inceleyelim. 

Adım 1: Desenler için verileri keşfedin
İlk olarak, yöneticinizden veya veri sahibinden güncel satış kayıtlarına ve web sitesi analiz raporlarına erişmesini istersiniz. Bu, müşterilerin şirketin mevcut web sitesinde nasıl davrandıkları, kimin ziyaret ettiği, şirketten kimin satın aldığı ve ne kadar satın aldıkları hakkında temel bilgileri içerir.

Verileri incelerken, şirketin web sitesini en sık ziyaret edenler arasında bir model fark edersiniz: coğrafya ve satın alımlara harcanan daha büyük miktarlar. Daha fazla analizle, bu bilgiler şu anda kuzeydoğuda satışların neden bu kadar güçlü olduğunu açıklayabilir ve şirketinizin yeni web sitesi aracılığıyla onları daha da güçlü hale getirmenin yollarını bulmasına yardımcı olabilir. 

Adım 2: Görsellerinizi planlayın
Daha sonra verileri iyileştirmenin ve analizinizin sonuçlarını sunmanın zamanı geldi. Şu anda, birkaç farklı tabloya yayılmış çok sayıda veriniz var, bu da sonuçlarınızı yönetim ve pazarlama ekibiyle paylaşmanın ideal bir yolu değil. Bulgularınızı hedef kitlenize hızlı ve etkili bir şekilde açıklayan bir veri görselleştirmesi oluşturmak isteyeceksiniz. Hedef kitlenizin satış odaklı olduğunu bildiğiniz için, kullandığınız veri görselleştirmesinin şunları yapması gerektiğini zaten biliyorsunuzdur:

Satış rakamlarını zaman içinde göster

Satışları konuma bağlayın

Satış ve web sitesi kullanımı arasındaki ilişkiyi gösterin

Hangi müşterilerin büyümeyi desteklediğini gösterin

Adım 3: Görsellerinizi oluşturun
Artık ne tür bilgi ve içgörüler görüntülemek istediğinize karar verdiğinize göre, gerçek görselleştirmeleri oluşturmaya başlamanın zamanı geldi. Bir sunum için doğru görselleştirmeyi oluşturmanın veya paydaşlarla paylaşmanın bir süreç olduğunu unutmayın. Farklı görselleştirme formatlarını denemeyi ve aradığınızı elde edene kadar ayarlamalar yapmayı içerir. Bu durumda, farklı görsellerin bir karışımı bulgularınızı en iyi şekilde iletecek ve analizinizi paydaşlar için en ilgi çekici hikayeye dönüştürecektir. Böylece, verileri düzenlemek ve görsellerinizi oluşturmak için elektronik tablolarınızdaki yerleşik grafik özelliklerini kullanabilirsiniz.

![image.png](attachment:926ea2a8-c486-4ca2-9dc0-0e9e4d2450c2.png)
</details>

Veri görselleştirme araç setinizi oluşturun
Veri görselleştirme için kullanabileceğiniz birçok farklı araç vardır. 

Çizgi ve çubuk grafikler gibi basit görselleştirmeler oluşturmak için elektronik tablonuzdaki görselleştirme araçlarını kullanabilirsiniz.
...
<details>
    <summary>Terimler Sözlüğü</summary>
    **Öznitelik:** Bir tablodaki bir sütunu etiketlemek için kullanılan verilerin karakteristiği veya kalitesi

**Gözlem:** Bir tablonun bir satırında bulunan bir veri parçasını tanımlayan özellikler
</details>
...
- Önyargı ve Adaletin Karmaşıklığı
...
<details>
    <summary>Vaka Analizi Soru Cevap 1</summary>
    Bir lise yönetimi, öğretim kadrosunun etkinliğini artırmak için tüm öğretmenlere bir atölye çalışmasına katılma fırsatı sundu. Katılmaları zorunlu değildi; bunun yerine yönetim öğretmenleri kaydolmaları için teşvik etti. Çalışan 43 öğretmenden 19'u atölye çalışmasına katılmayı seçti.

Akademik yılın sonunda idare, kadrodaki tüm öğretmenler için öğretmen performansına ilişkin veri toplamıştır. Veriler öğrenci anketi aracılığıyla toplanmıştır. Ankette öğrencilerden her bir öğretmenin etkinliğini 1 (çok zayıf) ile 6 (çok iyi) arasında derecelendirmeleri istenmiştir.

İdare, çalıştaya katılan öğretmenlerin verilerini katılmayan öğretmenlerin verileriyle karşılaştırmıştır. Karşılaştırma, çalıştaya katılan öğretmenlerin ortalama puanının 4.95, katılmayan öğretmenlerin ortalama puanının ise 4.22 olduğunu ortaya koymuştur. Yönetim çalıştayın başarılı olduğu sonucuna varmıştır.

Bu senaryoyu düşünün:

<ul>
    <li>Adil veya adil olmayan uygulamalara örnekler nelerdir?</ul>
    <li>Bir veri analisti adil olmayan uygulamaları nasıl düzeltebilir?</ul>
</ul>
<details>
    <summary>Geri Bildirim</summary>
    Öğrendiklerinizi düşünceli bir öz-yansıtma ile pekiştirerek harika bir iş çıkardınız! Yanıtınızda muhtemelen bunun adil olmayan bir uygulama örneği olduğunu belirtmişsinizdir. İdarenin yaptığı gibi çalıştayın başarılı olduğu sonucuna varmak cazip gelebilir. Ancak, atölye çalışması rastgele değil gönüllülük esasına dayandığından, atölye çalışmasına katılım ile yüksek not arasında nedensel bir ilişki kurmak uygun değildir.

Çalıştay etkili olmuş olabilir, ancak derecelendirmelerdeki farklılıklar için başka açıklamalar da göz ardı edilemez. Örneğin, bir başka açıklama da çalıştaya gönüllü olarak katılan personelin daha iyi, daha motive öğretmenler olması olabilir. Bu öğretmen grubu, çalıştay etkili olsa da olmasa da daha yüksek puan alacaktır.

Öğrenci anket yanıtları ile çalıştaya katılım arasında doğrudan bir bağlantı olmaması da dikkat çekicidir. Veri analisti, öğretmenlerin çalıştaya katılmak üzere rastgele seçilmesini isteyerek bu durumu düzeltebilir. Ayrıca, öğretmenlerin atölyede öğrendikleri bir tekniğin başarısı gibi atölye katılımıyla daha doğrudan ilgili bir şeyi ölçen veriler de toplayabilirler.
</details>
    
</details>
<details>
    <summary>Vaka Analizi Soru Cevap 2</summary>
    Bir otomotiv şirketi sürücüsüz araç prototipinin sürüş yeteneklerini test ediyor. Testleri çeşitli yol türlerinde, özellikle de yarış pisti, patika yol ve toprak yolda gerçekleştiriyorlar.

Araştırmacılar prototipi yalnızca gündüzleri test ediyor. İki tür veri topluyorlar: sürüşler sırasında araçtan alınan sensör verileri ve araç üzerindeki kameralardan alınan sürüşlerin video verileri.

İlk testlerden sonra verileri gözden geçiriyorlar. Sonuçlar, yeni sürücüsüz otomobilin yolların her birinde performans standartlarını karşıladığını gösteriyor. Sonuç olarak araç, çeşitli hava koşullarında sürüşü de içeren bir sonraki test aşamasına geçebilir. 
...
<details>
    <summary>Geri Bildirim</summary>
    Bir kez daha, bu vaka çalışması adil olmayan bir uygulamayı göstermektedir. Yanıtınızda muhtemelen araştırmacıların prototipi üç farklı pistte test etmelerine rağmen testleri sadece gündüz gerçekleştirdiklerinden bahsetmişsinizdir.

Her bir pistteki koşullar gündüz ve gece çok farklı olabilir ve bu da sonuçları önemli ölçüde değiştirebilir. Veri analisti, prototipin günün herhangi bir saatinde pistlerde nasıl performans gösterdiğine dair tam bir perspektif elde etmek için test ekibinden gece testlerini de eklemesini isteyerek bu durumu düzeltmelidir.
</details>
    
</details>
<details>
    <summary>Vaka Analizi Soru Cevap 3</summary>
    Bir eğlence parkı, tesislerine yeni gezinti araçları eklemeyi planlamaktadır. İlk olarak, ziyaretçilerin parkın ne tür yeni gezintiler yapmasını istediklerini belirlemeleri gerekir. Ziyaretçilerin ilgi alanlarını anlamak için park bir anket geliştirir.

Anketi roller coaster'ların yakınında dağıtmaya karar verirler çünkü kuyruklar ziyaretçilerin tüm soruları yanıtlayabilecekleri kadar uzundur. Bu anket verilerini topladıktan sonra, ankete katılanların çoğunun parkta daha fazla hız treni istediğini görürler. Ziyaretçilerin çoğu tercih ettiği için daha fazla hız treni eklemeleri gerektiği sonucuna varırlar.
...
<details>
    <summary>Geri Bildirim</summary>
    Düşünceli bir değerlendirme, anketlerin ziyaretçilerin yanıt vermek için zaman bulabilecekleri yerlerde dağıtılması kararı hakkında bilgi içerirdi. Aksi takdirde, yanlışlıkla örnekleme yanlılığı ortaya çıkar.

Ankete yanıt verenler sadece hız trenleri için sırada bekleyen kişilerdir. Bu durum anket sonuçlarını haksız yere saptırabilir, çünkü katılımcılar lunapark trenlerini tercih ediyor olabilir. Bir veri analisti, anketi lunaparkın giriş ve çıkışlarında dağıtarak örnekleme yanlılığını azaltabilir. Böylece lunapark treni hayranları hedef alınmamış ve parkın genel kitlesinden sonuçlar elde edilmiş olur.
</details>
...
2. İş Ararken Profesyonel Deneyimlerinizden Yararlanın
...
- Bu tür senaryolarda:
    ...
    - Düşünce sürecinizi net bir şekilde açıklayın.
- Doğru bir çözüm her zaman olmayabilir; önemli olan, probleme yaklaşımınızı göstermenizdir.

7. İşe Alım Görevlisi ve Yöneticisi ile Doğrudan İletişim

- Sadece online başvuru yapmakla yetinmeyin. İşe alım görevlisi veya yöneticisiyle doğrudan iletişim kurmaya çalışın.
- LinkedIn üzerinden bir kahve sohbeti teklif edin veya özgeçmişinizi doğrudan onlara gönderin.
- Online başvurular bazen sonuçsuz kalabilir; bu nedenle, doğrudan iletişim kurarak ilginizi göstermeye özen gösterin.

8. Sabırlı ve Kararlı Olun

- İlk denemede yanıt alamasanız bile tekrar iletişim kurmayı deneyin.
- Doğru işe ulaşmak, birkaç deneme ve sabır gerektirebilir.
</details>

<details>
    <summary>Terimler Sözlüğü</summary>
    - İş görevi: Soru veya sorun veri analizi bir işletme için çözülür

- Adalet: Önyargı yaratmayan veya pekiştirmeyen bir veri analizi kalitesi 

- Aşırı örnekleme: Bir popülasyondaki baskın olmayan grupların örneklem büyüklüğünü artırma süreci. Bu, onları daha iyi temsil etmenize ve dengesiz veri kümelerini ele almanıza yardımcı olabilir 
